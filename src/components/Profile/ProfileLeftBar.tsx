...
const ProfileLeftBar = () => {
    return (
        ...
        <div className={styles['profile-pic']}> 
            ...
            <p className={styles['icon']}><BiCamera/></p>
        </div>
        ...
        <p>This is not your username or pin. This name will be visibile to your WhatsApp contacts.</p>
            </div>
        <div className={styles['profile-text']}>
                <p className={styles['profile-name']}>About</p>
                <img src={Frame}alt="icon" />
        </div>
        <p className={styles['paragraph-primary']}>Notification off, please expect delayed revert. Call if very urgent.</p>
  </div>
        )
 }
